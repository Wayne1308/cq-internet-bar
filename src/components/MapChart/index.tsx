...
import './index.scss';
import shanghaiGeoJson from '../../assets/map/shanghai.geo.json';
import chongqingGeoJson from '../../assets/map/chongqing.geo.json';
...
class MapChart extends React.Component<any, any> {
    ...
    render() {
        ...
        return <Echarts options={ options } mapJson={ chongqingGeoJson }></Echarts>
    }
}
